      ...
      <section class="wrapper">
        <div class="row">
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="{{asset('Admin/img/asser.jpg')}}" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
                        <name>Asser Ibrahim</name>
                        sent you a message.
                      </p>
                      <p class="small">3 hours ago</p>
                      <p class="message">we have an order </p>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img src="{{asset('Admin/img/mk.jpg')}}" class="img-circle" width="50"></p>
                  <p><b>Mohamed K.Abdeldayem </b></p>
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img src="{{asset('Admin/img/ahmed.jpg')}}" class="img-circle" width="80">
                      <h4>Ahmed Alaa</h4>
                    </div>
                  </div>
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="#">Eslam soliman</a> purchased an item.<br/>
                </p>
              </div>
            </div>
            <!-- Second Activity -->
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="#">Mohamed Lelo</a> subscribed to your newsletter.<br/>
                </p>
              </div>
            </div>
            <!-- Third Activity -->
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="#">El-fath Co</a> purchased a year subscription.<br/>
                </p>
              </div>
            </div>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{('Admin/img/Lelo.jpg')}}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">Mohamed Lelo</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset('Admin/img/eslam.jpg')}}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">Eslam Soliman</a><br/>
                  <muted>Available</muted>
                </p>
              </div>
            </div>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset('Admin/img/mk.jpg')}}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">Mohamed Abdeldayem</a><br/>
                  <muted>Available</muted>
                </p>
              </div>
            </div>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset('Admin/img/asser.jpg')}}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
